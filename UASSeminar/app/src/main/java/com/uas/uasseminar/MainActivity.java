    ...
    public void onClick(View view) {
        if (view == buttonAdd){
            if (editTextName.getText().toString().length()==0){
                editTextName.setError("Masukan Nama");
            } else if (editTextNim.getText().toString().length()==0){
                editTextName.setError("Masukan NIK");
            }else if (editTextAlamat.getText().toString().length()==0){
                editTextAlamat.setError("Masukan Alamat");
            } else  if (spinJk.getSelectedItem().toString().equals(JK[0])){
                addEmployee();
